...
export const ui = {
	fr: {
		...
		'about.p4': "J'enseigne depuis 2010 — à EM Lyon Business School, Centrale Lyon, INSEEC Grande Écoles, Faculté Catholique de Lille, Université Lyon 1, ILERI et HEIP, en français comme en anglais, ainsi qu'en formation continue pour les secteurs public et privé.",
		...
		'services.teaching.desc': "Formateur depuis 2010 à EM Lyon Business School, Centrale Lyon, INSEEC Grande Écoles, Faculté Catholique de Lille, Université Lyon 1, ILERI et HEIP.",
	...
	en: {
		...
		'about.p4': "I have been teaching since 2010 — at EM Lyon Business School, Centrale Lyon, INSEEC Grande Écoles, Faculté Catholique de Lille, Université Lyon 1, ILERI and HEIP, in French and English, along with executive training for the public and private sectors.",
		...
		'services.teaching.desc': "Lecturer since 2010 at EM Lyon Business School, Centrale Lyon, INSEEC Grande Écoles, Faculté Catholique de Lille, Université Lyon 1, ILERI and HEIP.",
	...
	zh: {
		...
		'about.p4': '我自 2010 年起任教——里昂高商（EM Lyon Business School）、里昂中央理工（Centrale Lyon）、INSEEC Grande Écoles、里爾天主教大學（Faculté Catholique de Lille）、里昂第一大學、ILERI 與 HEIP，以法語及英語授課，並為公私部門提供在職培訓。',
		'about.p5': '這一視野也在田野中形成——喀麥隆、柬埔寨、烏克蘭與台灣。',
		'about.p6': '課程、演講、媒體出席或顧問合作：各類形式詳見下文。',
		// Services
		'services.title': '服務範疇',
		'services.teaching.title': '課程與培訓',
		'services.teaching.desc': '自 2010 年起任教於里昂高商（EM Lyon Business School）、里昂中央理工（Centrale Lyon）、INSEEC Grande Écoles、里爾天主教大學（Faculté Catholique de Lille）、里昂第一大學、ILERI 與 HEIP。',
