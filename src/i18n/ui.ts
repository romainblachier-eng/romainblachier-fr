...
export const ui = {
	fr: {
		...
		'hero.pitch': "Énergie, réseaux, souveraineté — et ce que cela change en géopolitique, en particulier à Taïwan et dans l'Indo-Pacifique. J'enseigne, j'écris et j'interviens auprès d'écoles, de rédactions et d'institutions. Dix-huit ans du côté de la production d'électricité renouvelable, expert associé à la Fondation Jean-Jaurès.",
		...
		'about.p2': "Cette approche s'appuie sur l'expérience : dix-huit ans du côté de la production d'électricité renouvelable et douze ans de mandat à la Métropole de Lyon. Les marchés, les réseaux et la décision publique, je les ai pratiqués avant de les enseigner.",
		...
		'formateur.notes.desc': "L'essentiel du travail est écrit : notes de cadrage, diagnostics de secteur, rapports pour institutions et bailleurs. En 2026, une note de vision et de décision remise à l'unité de coordination de la réforme du secteur électrique camerounais, accompagnée d'un catalogue de formation pour l'académie régionale de l'énergie.",
		...
		'seo.description': "Énergie et géopolitique. Dix-huit ans dans la production d'électricité renouvelable, spécialiste Taïwan et Indo-Pacifique. Expertise, enseignement en grandes écoles, conseil, recherche appliquée.",
	},
	en: {
		// Nav
		'nav.home': 'Home',
		...
		'hero.pitch': "Energy, grids and sovereignty — and what they change geopolitically, particularly in Taiwan and the Indo-Pacific. I teach, I write, and I work with schools, newsrooms and institutions. Eighteen years on the generation side of renewable electricity, associate fellow at the Fondation Jean-Jaurès.",
		...
		'about.p2': "This approach is grounded in experience: eighteen years on the generation side of renewable electricity and twelve years in elected office in the Lyon metropolitan area. Markets, grids and public decision-making — I practised them before teaching them.",
		...
		'formateur.notes.desc': "Most of the work is written: scoping papers, sector diagnoses, reports for institutions and donors. In 2026, a vision and decision paper delivered to the coordination unit of Cameroon's electricity sector reform, together with a training catalogue for the regional energy academy.",
	...
	zh: {
		...
		'hero.pitch': '能源、電網與主權，以及它們在地緣政治上的意涵——尤其是台灣與印太。我教學、我寫作，也與院校、媒體與機構合作。在再生能源發電這一端工作十八年，讓·饒勒斯基金會副研究員。',
		'hero.cta': '與我聯絡',
		// About
		'about.title': '關於',
		'about.p1': '能源與地緣政治往往顯得技術性強、僅屬專家領域。我的工作是讓這些主題變得清晰而實用——無論對象是學生、編輯部或管理團隊。',
		'about.p2': '這一方法建立在實務經驗之上：在再生能源發電這一端工作十八年，並在大里昂都會區擔任民選代表十二年。市場、電網與公共決策，我先實踐，而後教學。',
