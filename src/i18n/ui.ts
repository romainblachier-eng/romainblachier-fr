...
export const ui = {
	fr: {
		...
		'travaux.publications.scientific': 'Think tanks et publications à comité scientifique',
	...
	en: {
		...
		'travaux.seo.description': "Publications, teaching and research by Romain Blachier. Lecturer at Grenoble École de Management, IEP Lyon, Université Lyon 1. Author of Guillotière(s). Energy and geopolitics.",
