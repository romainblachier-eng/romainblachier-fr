...
export const ui = {
	fr: {
		...
		'hero.pitch': "Marchés de l'énergie, géopolitique, Taïwan et Indo-Pacifique. Dix-huit ans dans le secteur de l'énergie, enseignant à Sciences Po Paris et EM Lyon depuis 2010, expert associé à la Fondation Jean-Jaurès.",
		...
		'about.p4': "J'enseigne depuis 2010 — à Sciences Po Paris, Sciences Po Lyon (IEP de Lyon), EM Lyon Business School, Centrale Lyon, ILERI et HEIP, en français comme en anglais, ainsi qu'en formation continue pour les secteurs public et privé.",
		'about.p5': "Ce regard s'est aussi construit sur le terrain — au Cameroun, au Cambodge, en Ukraine et à Taïwan.",
		...
		'services.teaching.desc': "Formateur depuis 2010 à Sciences Po Paris, Sciences Po Lyon (IEP de Lyon), EM Lyon Business School, Centrale Lyon, ILERI et HEIP.",
	...
	en: {
		...
		'hero.pitch': "Energy markets, geopolitics, Taiwan and the Indo-Pacific. Eighteen years in the energy sector, lecturer at Sciences Po Paris and EM Lyon since 2010, associate fellow at the Fondation Jean-Jaurès.",
		...
		'about.p4': "I have been teaching since 2010 — at Sciences Po Paris, Sciences Po Lyon (IEP de Lyon), EM Lyon Business School, Centrale Lyon, ILERI and HEIP, in French and English, along with executive training for the public and private sectors.",
		'about.p5': "This perspective was also shaped in the field — in Cameroon, Cambodia, Ukraine and Taiwan.",
		...
		'services.teaching.desc': "Lecturer since 2010 at Sciences Po Paris, Sciences Po Lyon (IEP de Lyon), EM Lyon Business School, Centrale Lyon, ILERI and HEIP.",
	...
	zh: {
		...
		'hero.pitch': '能源市場、地緣政治、台灣與印太。能源領域十八年資歷，2010 年起任教於巴黎政治學院與里昂高商，讓·饒勒斯基金會副研究員。',
		'hero.cta': '與我聯絡',
		// About
		'about.title': '關於',
		...
		'about.p4': '我自 2010 年起任教——巴黎政治學院、里昂政治學院（IEP de Lyon）、里昂高商（EM Lyon Business School）、里昂中央理工、ILERI 與 HEIP，以法語及英語授課，並為公私部門提供在職培訓。',
		'about.p5': '這一視野也在田野中形成——喀麥隆、柬埔寨、烏克蘭與台灣。',
		'about.p6': '課程、演講、媒體出席或顧問合作：各類形式詳見下文。',
		// Services
		'services.title': '服務範疇',
		'services.teaching.title': '課程與培訓',
		'services.teaching.desc': '自 2010 年起任教於巴黎政治學院、里昂政治學院（IEP de Lyon）、里昂高商（EM Lyon Business School）、里昂中央理工、ILERI 與 HEIP。',
