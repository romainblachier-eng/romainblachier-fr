...
export const ui = {
	...
	zh: {
		...
		'hero.pitch': '能源市場、地緣政治、台灣與印太。能源領域十八年資歷，2010 年起任教於法國高等院校，讓·饒勒斯基金會特聘專家。',
		'hero.cta': '與我聯絡',
		// About
		'about.title': '關於',
		...
		'about.p3': '身為讓·饒勒斯基金會（Fondation Jean-Jaurès）特聘專家，我定期為智庫與法國及海外媒體撰稿，尤其關注以科學與技術合作作為國力槓桿。',
