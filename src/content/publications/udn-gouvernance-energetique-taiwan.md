...
description: >-
  ...
  fois, une fois en prix subventionné et une fois en impôts pour combler les
  pertes de l'opérateur public ? 420 milliards de NT$ de déficit cumulé, dix
...
1. **Le solaire décentralisé et le stockage d'abord** — ce qui se déploie vite, près de la consommation, et soulage le réseau dans l'immédiat.
2. **La géothermie ensuite** — Taïwan est assise sur la **ceinture de feu du Pacifique** et dispose là d'une ressource pilotable largement sous-exploitée.
3. **Puis le redémarrage du nucléaire et les petits réacteurs modulaires (SMR)** — pour la base décarbonée de long terme.
...
→ [Lire la tribune sur le 聯合報 (United Daily News)](https://udn.com/news/story/7339/9549010)
