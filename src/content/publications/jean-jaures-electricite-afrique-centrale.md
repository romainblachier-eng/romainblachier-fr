...
kind: tribune
title: "Ma note pour la Fondation Jean-Jaurès (France) : Intégrer l'électricité en Afrique centrale — la métropole comme arbitre absent"
description: "Publiée par la Fondation Jean-Jaurès, cette note analyse les défis de l'intégration électrique dans trois capitales d'Afrique centrale — Kinshasa, Douala, Brazzaville — où les métropoles concentrent la demande sans disposer du pouvoir de décision sur les systèmes électriques."
...
[Lire la note complète sur le site de la Fondation Jean-Jaurès](https://www.jean-jaures.org/publication/integrer-lelectricite-en-afrique-centrale-kinshasa-douala-brazzaville-la-metropole-comme-arbitre-absent/)

---

*Logo : Fondation Jean-Jaurès — utilisé à des fins éditoriales pour signaler l'éditeur de la publication.*
